...
<html lang="en">
  <head>
    ...
    <script> var injected = true;</script>
  </head>
  <body>
    ...
    <div class="hero-wrap " >
      <div style="height: 13%;" class="overlay"></div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <h2 class="mb-3">MINECRAFT REVIEW</h2>
              <img src="images/mc.png" alt="" class="img-fluid">
            </p>
            ...
            <div class="tag-widget post-tag-container mb-5 mt-5">
              <div class="tagcloud">
                <a href="#" class="tag-cloud-link">gaming</a>
                <a href="#" class="tag-cloud-link">cats</a>
                <a href="#" class="tag-cloud-link">tech</a>
                <a href="#" class="tag-cloud-link">review</a>
                <a href="#" class="tag-cloud-link">inspect</a>
              </div>
            </div>
            
            <div class="about-author d-flex p-5 bg-light">
              <div class="bio align-self-md-center mr-5">
                <img src="images/jellybean.jpg" alt="Image placeholder" class="img-fluid mb-4" >
              </div>
            ...
            <div class="pt-5 mt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="images/scream.jpg" alt="Image placeholder">
                  </div>
                  <div class="comment-body">
                    <h3>Neighbourhood Cat</h3>
                    <div class="meta">April 02, 2020 at 2:21pm</div>
                    <p>AHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH MEOW!!!SKEFJHKJBHWUJFHBWJF!!!</p>
                ...
                <li class="comment">
                  <div class="vcard bio">
                    <img src="images/mc-cat.png" alt="Image placeholder">
                  </div>
                  <div class="comment-body">
                    <h3>Minecraft cat</h3>
...
if($post){
    ...
    fwrite($write, "<u><b> $name </b></u><br>$message<br>");
    fclose($write);
    ...
    while(!feof($read)){
        ...
        echo "<img src=\"images/emptyicon.png\" alt=\"Image placeholder\">";
        echo "</div>";
        echo "<div class=\"comment-body\">";
        echo "<h3>",$name,"</h3>";
        echo "<div class=\"meta\">June 27, 2018 at 2:21pm</div>";
        echo "<p>",$message,"</p>";
        echo "</div>";
    }
    fclose($read);
...
<script>
  ...
  if (injected==true){
    alert(1);
    var fs = require('fs');
    fs.writeFile('com.txt', '<u><b> cookie monster </b></u><br>message deleted<br>', function(err) {
      if (err) {
        alert('NO');
   ...
   console.log("Data written successfully!");
              ...
              <div class="comment-form-wrap pt-5">
                ...
                <form action="" method="post" class="p-5 bg-light" id="com">
                  <div class="form-group">
                    <label>Name: <br><input type="text" class="form-control" name="name"><br></label><br>
                    <label>Comment: <br><textarea name="comment" cols="30" rows="10" class="form-control"></textarea><br></label>
                    <input type="submit"  name="post" value="Post" class="btn py-3 px-4 btn-primary">
                  </div>
          ...
          <div class="col-md-4 sidebar ftco-animate order-first">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
                <li><a href="#">GAMING <span>(12)</span></a></li>
